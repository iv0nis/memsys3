...
⚠️ **EJECUTAR DESDE:** `***/memsys3` (repositorio español)
...
Sincronizar cambios desde `***/memsys3/memsys3_templates/` (versión española) hacia `***/memsys3_CAT/memsys3_templates/` (versión catalana), traduciendo al catalán todos los archivos distribuibles.
...
- **Repositorio principal (español - ORIGEN):**
  - Ruta: `***/memsys3`
  - Branch: `master`
  - Directorio templates: `***/memsys3/memsys3_templates/`

- **Repositorio catalán (català - DESTINO):**
  - Ruta: `***/memsys3_CAT`
  - Branch: `catalan`
  - Directorio templates: `***/memsys3_CAT/memsys3_templates/`
...
cp -r memsys3_templates/* ***/memsys3_CAT/memsys3_templates/
```
