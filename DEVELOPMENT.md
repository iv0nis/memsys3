...
Antes de modificar nada, lee `PRINCIPLES.md` (10 principios sistémicos invariantes).

## Estructura del Repositorio

```
memsys3/                  # repo raíz (https://github.com/iv0nis/memsys3)
├── README.md
├── PRINCIPLES.md          # stub raíz
├── UPDATE.md              # guía actualización
├── DEVELOPMENT.md         # este archivo
├── CONTRIBUTING.md        # cómo contribuir
├── CHANGELOG.md           # historial versiones
├── LICENSE
├── .githooks/             # hooks anti-leak (opt-in)
...
│   ├── agents/, memory/, prompts/, prompts-dev/, backlog/, docs/
```
...
Ver `memsys3/backlog/README.md` para detalles del sistema.
...
memsys3 es un repo público único (`github.com/iv0nis/memsys3`), sin separación dev/público. El desarrollo con dog-fooding y los templates distribuibles coexisten en el mismo repositorio.
